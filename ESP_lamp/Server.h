...
void handle_root(){
  String page_code = "<form action=\"/wifi\" method=\"POST\">SSID:<input type=\"text\" name=\"ssid\"><br>Password:<input type=\"password\" name=\"password\"><input type=\"submit\" value=\"Submit\"></form>";;
